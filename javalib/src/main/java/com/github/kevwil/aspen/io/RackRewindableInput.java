 ...
 * @since Jan 27, 2011
 */
public class RackRewindableInput
        extends RackBaseInput
{
    ...
    public RackRewindableInput( Ruby runtime, RackEnvironment env )
    throws IOException
    {
        super( runtime, getRackRewindableInputClass( runtime ), env );
    }

    private class MemoryBufferRackInput
    implements RackInput
    {
        ...
        private MemoryBufferRackInput( ReadableByteChannel input )
        throws IOException
        {
        ...
        private byte[] readUntil( int match, long count )
        throws IOException
        {
    ...
    private class RubyTempfileRackInput
            extends RubyIORackInput
    {
