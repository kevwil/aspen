...
module Aspen
  # Run a command through the +aspen+ command-line script.
  class Command
    include Logging
    
    class << self
      # Path to the +aspen+ script used to control the servers.
    ...
    # Send the command to the +aspen+ script
    def run
      shell_cmd = shellify
      trace shell_cmd
    ...
    def shellify
      ...
      raise ArgumentError, "Path to aspen script can't be found, set Command.script" unless self.class.script
